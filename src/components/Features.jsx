const Features = () => {
  return (
    <section id="about" className=" bg-gray-900 flex items-center content-center">
      <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        ...
        <div className="space-y-8 md:grid md:grid-cols-1 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div className="border text-gray-300 p-4 rounded-md">
          ...
          <div className="border border-grey-400 p-4 rounded-md">
            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full  lg:h-12 lg:w-12 bg-primary-900">
              <svg
                className="w-5 h-5  lg:w-6 lg:h-6 text-primary-300"
                fill="currentColor"
